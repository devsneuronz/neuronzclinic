  ...
  return (
    <aside className={cn("relative flex h-full flex-col transition-all duration-300 ease-in-out", "bg-[var(--sidebar-custom-bg)] border-r border-border", isCollapsed ? "w-[68px]" : "w-[200px]")}>
      ...
      <Button
        ...
        className="absolute top-1/2 right-0 h-14 w-4 translate-x-[50%] -translate-y-1/2 rounded-sm p-0! shadow-md z-41 bg-[var(--sidebar-custom-primary)] text-[var(--sidebar-custom-primary-fg)] border border-[var(--sidebar-custom-border)] hover:bg-(--sidebar-custom-primary)/70"
      >
