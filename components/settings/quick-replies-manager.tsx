...
export function QuickRepliesManager() {
  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col gap-5 overflow-visible pt-2 lg:w-[45%] lg:overflow-hidden xl:w-[40%]">
        <div className="relative rounded-xl border border-dashed border-border bg-muted/20 text-sm text-muted-foreground">
          ...
          <div className="relative p-5 sm:p-6">
            <div className="mb-6 flex items-start justify-between gap-3 border-b border-border/50 pb-5">
              <div>
            ...
            <div className="space-y-5">
              <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_180px]">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex h-10 items-center justify-between rounded-md border border-input bg-background px-3 shadow-sm">
                    <span className="text-xs font-medium text-muted-foreground">{form.isActive ? "Ativa no chat" : "Inativa"}</span>
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-semibold text-foreground">Mensagem da resposta</label>
