      ...
      <Tabs value={bottomTab} onValueChange={(value) => setBottomTab(value)} className="flex flex-col flex-1 overflow-hidden gap-0 border-t border-border">
        ...
        <TabsContent value="consultas" className="w-full flex-1 overflow-y-auto max-h-64 p-4 m-0 data-[state=inactive]:hidden! [data-state=active]:block custom-scrollbar">
          {isLoadingLatestAppointment ? (
            ...
            <p className="text-sm text-muted-foreground py-2">Nenhuma consulta registrada</p>
          )}
        </TabsContent>

        <TabsContent value="tarefas" className="w-full flex-1 overflow-y-auto max-h-64 p-4 m-0 data-[state=inactive]:hidden! [data-state=active]:block custom-scrollbar">
          {isLoadingContactTasks ? (
            ...
            <p className="text-sm text-muted-foreground py-2">Nenhum aviso ou tarefa</p>
          )}
        </TabsContent>
      </Tabs>
